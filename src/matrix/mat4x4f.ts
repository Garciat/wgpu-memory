...
import { type Float32Type, GPU_MAT4X4, type MatrixType } from "../types.ts";
...
/**
 * A 4x4 matrix of Float32. The components are stored in column-major order per WGSL.
 *
