import type { AnyFloatingPointType, MatrixType } from "../types.ts";

export function matrixToString<
  NCol extends 2 | 3 | 4,
  NRow extends 2 | 3 | 4,
>(matrix: MatrixType<AnyFloatingPointType, NCol, NRow>): string {
...
export function matrixToCode<
  ...
  NRow extends 2 | 3 | 4,
>(
  matrix: MatrixType<AnyFloatingPointType, NCol, NRow>,
  namespace: string,
): string {
