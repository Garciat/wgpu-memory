...
import { Mat3x3H } from "../../src/matrix/mat3x3h.ts";

import * as memory from "../../src/mod.ts";

const TestOffset = 16;

const TypeName = "Mat3x3H";
...
const MatrixByteSize = 24;

const MatrixAlignment = 8;

const MatrixArrayStride = 24;
...
Deno.test(`${TypeName}.toString`, () => {
  assertEquals(String(M), "mat3x3<f16>");
});

Deno.test(`${TypeName}.toCode`, () => {
  assertEquals(M.toCode("memory"), "memory.Mat3x3H");
});
