...
import { Mat2x2F } from "../../src/matrix/mat2x2f.ts";

import * as memory from "../../src/mod.ts";

const TestOffset = 16;

const TypeName = "Mat2x2F";
...
const MatrixByteSize = 16;

const MatrixAlignment = 8;

const MatrixArrayStride = 16;
...
Deno.test(`${TypeName}.toCode`, () => {
  assertEquals(M.toCode("memory"), "memory.Mat2x2F");
});
